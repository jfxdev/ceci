...
type Services struct {
	...
	EnvironmentTemplates *service.EnvironmentTemplateService
	Parameters           *service.ParameterService
	Flags                *service.FlagService
	APIKeys              *service.APIKeyService
	Maintenance          *service.MaintenanceService
	AccessGroups         *service.AccessGroupService
	OIDC                 *service.OIDCConfigurationService
}
...
type parameterServiceAdapter struct{ service *service.ParameterService }
